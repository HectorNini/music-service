    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/tracks/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/tracks/{id}").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/statistics/top-tracks").hasRole("ADMIN")
                        .requestMatchers("/api/statistics/top-playlists").hasRole("ADMIN")
                        .requestMatchers("/api/statistics/user-count").hasRole("ADMIN")
